...
function world_page():string {
    ...
    $body='<link rel="stylesheet" href="/world-cafes.css?v=20260907tables"><script src="/world-cafes.js?v=20260907map36" defer></script>'.tabs(false,true).'<p class="dn-lead">世界の、手話でつながるカフェを探す。</p><p>地域・ブランド・手話との関わりから、お店や定期開催の場を探せます。営業時間は現地時間です。</p>';
