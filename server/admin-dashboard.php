...
function admin_records_table(string $kind):string {
    ...
    $base=['view'=>'records','kind'=>$kind,'scope'=>$scope,'country'=>$country,'verification'=>$verification,'q'=>$q,'publication'=>$pub,'status'=>$state,'sort'=>$sort,'dir'=>$dir,'limit'=>$size];
