...
function cafe_discovery_guide(array $all):string {
    ...
    $out='<section class="dn-cafe-guide" id="cafe-regions" aria-labelledby="cafe-regions-heading"><h2 id="cafe-regions-heading">地域から手話カフェを探す</h2><p>お住まいの地域や、お出かけ先から探してみてください。掲載件数には、営業状況を確認中のお店も含みます。</p><div class="dn-region-links">';
    ...
    $out.='</div></section>';
    $out.='<section class="dn-cafe-guide" id="cafe-guide" aria-labelledby="cafe-guide-heading"><h2 id="cafe-guide-heading">手話カフェが初めての方へ</h2><p>手話カフェは、手話や筆談での会話、ろう文化との出会いを楽しめるお店や交流の場です。常設のお店もあれば、カフェの一角や公共施設などで、決まった日に開かれる場もあります。</p>';
    foreach([
