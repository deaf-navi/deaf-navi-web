...
${feedUrl ? `  <link rel="alternate" type="application/rss+xml" title="${escapeHtml(SITE_NAME)}" href="${feedUrl}">\n` : ''}  <link rel="icon" href="${basePath}favicon.ico?v=20260917b" sizes="16x16 32x32 48x48">
  <link rel="icon" href="${basePath}icons/favicon-48.png?v=20260917b" type="image/png" sizes="48x48">
  <link rel="apple-touch-icon" href="${basePath}icons/apple-touch-icon.png?v=20260917b" sizes="180x180">
  <link rel="manifest" href="${basePath}manifest.webmanifest?v=20260917b">
    ...
    <div class="dn-shell-inner">
      <div class="dn-shell-top">
        <a class="dn-shell-brand" href="${escapeHtml(homeHref)}" aria-label="Deaf Navi ${en ? 'home' : 'ホーム'}">
          <span class="dn-shell-mark" aria-hidden="true"><img src="${escapeHtml(homeHref.includes('index') ? homeHref.slice(0, homeHref.lastIndexOf('/') + 1) : homeHref)}icons/icon-192.png?v=20260917b" alt="" width="36" height="36"></span>
